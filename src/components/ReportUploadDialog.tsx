...
import { uploadAndAnalyzeReport, ReportAnalysis } from "@/api/reportAnalysisApi";

interface ReportUploadDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  patientId: string;
  onUploadSuccess: (analysis: ReportAnalysis) => void;
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an image or PDF of the test report. It will be analyzed using AI to extract lab values and generate insights.
          </DialogDescription>
        </DialogHeader>
